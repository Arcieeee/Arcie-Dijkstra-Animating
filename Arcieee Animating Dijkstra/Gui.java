...
{ 
    ...
    public Gui(int x, int y, String title) //Contructor gets title and x and y values
    {
        ...
        //Define Menu 4
        menu4 = new JMenu("Graphics Menu"); menuBar.add(menu4); 
    ...
    public void createDialogExample(){ //for dialogue when needed
    ...
    public void actionPerformed(ActionEvent c){ //Method for responding to user input when selecting menu items
        ...
        switch (cmd){ //Switch statement to determine what action it is
            ...
            case "Run Algorithm" : algorithm.runAlgorithm(); //Run Algorithm
                break;
            case "Import Graph" : InD Import = new InD("Graph format:numOfNodes,Node1,xPos1,xPos2,Node2 etc...,numOfEdges,Edge1Start,Edge1End,Weight,Edge2Start etc..."); Import.setLocationRelativeTo(this); Import.setVisible(true); String Graph = Import.getText(); if(Graph==null||Graph==""){System.out.println("No Input");}else{processImport(Graph);} //Get User input, Call Process method for input if the input is not null.
                break;
